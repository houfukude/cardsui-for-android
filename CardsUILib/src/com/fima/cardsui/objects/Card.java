...
public abstract class Card extends AbstractCard {
	...
	public Card(String title, Bitmap bitmap) {
		this.title = title;
		this.bitmap = bitmap;
	}
	...
	public Card(Bitmap bitmap, String titlePlay, String description,
			String titleColor, Boolean hasOverflow, Boolean isClickable) {
		this.bitmap = bitmap;
		this.titlePlay = titlePlay;
		this.description = description;
	 ...
	 *            the view to convert, with root Id equal to Supports.Card.getId()
